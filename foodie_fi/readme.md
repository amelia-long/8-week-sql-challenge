...
Output: zero - this is surprising since the default plan after the free trial period is Pro Monthly: I'd expect at least some customers to downgrade to the cheaper Basic Monthly plan.

## C. Challenge Payment Question

This requires a recursive CTE to generate payment data: working on it!
